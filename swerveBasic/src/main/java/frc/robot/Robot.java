...
public class Robot extends TimedRobot {
  ...
  public void teleopPeriodic() {
    ...
    objects.motorCalculator.allWheelDrive(m_controller.getX(GenericHID.Hand.kLeft), m_controller.getY(GenericHID.Hand.kLeft), m_controller.getX(GenericHID.Hand.kRight), 0.00, 0.4);
  }
